...
const commonConfig = function webpackConfig(): WebpackConfig {
  ...
  config.module = {
    rules: [
      ...
      { test: /\.styl$/, use: ['to-string-loader', 'css-loader', 'stylus-loader'], include: path.resolve('src/app')},
      { test: /\.styl$/, loader: 'style-loader!css-loader!stylus-loader', include: path.resolve('src/assets/styles')},
