 ...
 * When including 3rd party libs you also need to include the type definition for the module
 ...
 *
 * If you're importing a module that uses Node.js libs which are CommonJS you need to import as
 *
